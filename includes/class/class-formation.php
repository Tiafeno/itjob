...
class Formation {
  ...
  public function __construct($formation_id = null, $private_access = false) {
    if (is_null($formation_id)) return new \WP_Error('broke', "Parametre manquant (formation_id)");
    $formation_id = (int) $formation_id;
    $post_type = get_post_type($formation_id);
    if ($post_type !== 'formation')
      return new \WP_Error('broke', "Erreur sur le type du post");
    ...
    $featured_position = get_field('featured_position', $formation_id);
